...
export const ModalContent = ({
  ...
  return (
    <div className={cn("flex flex-col flex-1 p-8 md:p-10 pointer-events-auto", className)}>
      {children}
    </div>
  );
};
...
export const ModalFooter = ({
  ...
  return (
    <div
      className={cn(
        "flex justify-end p-4 bg-gray-100 dark:bg-neutral-900 pointer-events-auto",
        className
      )}
    >
      {children}
