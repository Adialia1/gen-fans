"use client";
import productImage from "@/components/landing/assets/product-image.png";
...
export const ProductShowcase = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-gradient-to-b from-[#FFFFFF] to-[#ffe5ec] py-24 overflow-x-clip">
